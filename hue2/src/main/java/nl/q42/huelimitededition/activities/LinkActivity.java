...
import nl.q42.huelimitededition.adapters.BridgeAdapter;
import nl.q42.huelimitededition.dialogs.BridgeInfoDialog;
import nl.q42.huelimitededition.dialogs.BridgeLinkDialog;
import nl.q42.huelimitededition.dialogs.ErrorDialog;
...
public class LinkActivity extends Activity {
	...
	public void startLinkChecker(final Bridge b, final BridgeLinkDialog dialog) {
		...
		linkChecker.scheduleAtFixedRate(new TimerTask() {
			...
			public void run() {
				try {
					boolean pressed = HueService.createUser(b.getIp(), Util.ensureMaxLength(Util.getDeviceName()), username);
